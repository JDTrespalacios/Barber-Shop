...
class LoginController {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            if(empty($alertas)){
                ...
                if($usuario && $usuario->confirmado === "1") {
                    ...
                    Usuario::setAlerta('error', 'User does not exist or has not been validated');
                }
            }
        }
    ...
    public static function create(Router $router){
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            // Revisar que el array alertas esté vacío 
            if(empty($alertas)){
    ...
    public static function validate(Router $router) {
        ...
        if(empty($usuario)){
            ...
            $usuario->token = null;
            $usuario->guardar();
            Usuario::setAlerta('exito', 'Account Successfully Validated');
        }
        ...
        // Renderizar la vista
        $router->render('auth/validate-account',[
            'alertas' => $alertas
        ]);
    }
